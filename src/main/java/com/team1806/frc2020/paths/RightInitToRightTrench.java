...
public class RightInitToRightTrench implements PathContainer{
    ...
    public Path buildPath() {
        ...
        sWaypoints.add(new PathBuilder.Waypoint(151,250,15,150));
        sWaypoints.add(new PathBuilder.Waypoint(220,295,70,150));
        sWaypoints.add(new PathBuilder.Waypoint(370,295,0,150));
